...
let ResumeCommand = class ResumeCommand extends BaseCommand_1.BaseCommand {
    execute(message) {
        ...
        if ((_b = (_a = message.guild) === null || _a === void 0 ? void 0 : _a.queue) === null || _b === void 0 ? void 0 : _b.playing) {
            message.channel.send(createEmbed_1.createEmbed("warn", "Music is not paused.").setTimestamp()).catch(e => this.client.logger.error("RESUME_CMD_ERR:", e));
        }
        else {
            ...
            message.channel.send(createEmbed_1.createEmbed("info", "▶  **|**  Resumed the music for you").setTimestamp()).catch(e => this.client.logger.error("RESUME_CMD_ERR:", e));
        }
    }
};
tslib_1.__decorate([
